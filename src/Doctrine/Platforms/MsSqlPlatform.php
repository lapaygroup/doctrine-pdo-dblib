...
namespace LapayGroup\DoctrinePdoDblib\Doctrine\Platforms;
...
class MsSqlPlatform extends AbstractPlatform
{
    ...
    public function getDropForeignKeySQL($foreignKey, $table)
    {
        ...
        $table = $this->getSchemaMappedTableName($table);
...
//        $table = $this->getSchemaMappedTableName($table);
    ...
    public function getListTableIndexesSQL($table, $currentDatabase = null)
    {
        ...
        return "exec sp_helpindex '" . preg_replace('/^(.+?)\.(.+)$/', "[$1].[$2]", $table) . "'";
    }
    ...
    {
       //:TODO: in linux you have to set in /etc/freetsd/locales.conf this date format
       return 'Y-m-d H:i:s';
    }
